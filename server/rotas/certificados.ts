...
async function gerarPdfCertificado(condominioNome: string, bloco: string, rotuloTrimestre: string, kg: number) {
  ...
  desenhar(`${equivalencias.litrosAguaPoupados.toLocaleString("pt-BR")} litros de água e ${equivalencias.co2EvitadoKg.toLocaleString("pt-BR")} kg de CO₂e evitados.`, 90, 224, 11);
